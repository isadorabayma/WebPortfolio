...
export const initialSectionInfo: SectionInfo[] = [
    {
      ...
      margin: "-mt-[5rem] left-[18rem] lg:left-[29rem]",
      right: "w-[42rem] h-[60rem] -left-[11rem] lg:left-[0rem]",
    },
    {
      name: "Skills",
      z: "z-[2]",
      rotate: "top-[25rem] lg:top-[26rem] -rotate-[25deg]",
      margin: "mt-[1rem] sm:mt-[3rem] left-[21rem] sm:left-[22rem] lg:left-[33rem]",
      right: "w-[42rem] h-[60rem] -left-[11rem] lg:left-[0rem]",
    },
    {
      name: "Experience",
      ...
      margin: "mt-[7rem] sm:mt-[11rem] left-[24rem] sm:left-[26rem] lg:left-[37rem]",
      right: "w-[42rem] h-[60rem] -left-[11rem] lg:left-[0rem]",
    },
    {
      name: "Projects",
      z: "z-10",
      rotate: "-rotate-[30deg] md:-rotate-[20deg]",
      margin: "mt-[27rem] md:mt-[18rem] lg:mt-[15rem] h-[30rem] w-[14rem] md:h-[49rem] md:w-[30rem]",
      right: "left-[8rem] md:left-auto md:-right-[15rem] lg:-right-[8rem] xl:right-12",
    },
    {
      name: "Contact",      
      z: "z-1",
...
export const movedSectionInfo: SectionInfo[] = [
  {
    ...
    right: "w-full max-w-[42rem] max-h-[60rem] right-0 lg:right-[14rem]",
  },
  {
    name: "Skills",
    z: "z-30",
  ...
  },
  {
    ...
    z: "z-30",
    rotate: "rotate-0",
    margin: "mt-6 lg:mt-6 h-[45rem] w-[21rem] md:h-[49rem] md:w-[30rem]",
    right: "left-5 lg:left-auto lg:right-5",
  },
  {
    name: "Contact",
    z: "z-30",
