  ...
  return (
    <div>
      <div className="flex lg:pt-[40rem]">
        <div className="absolute transition-all duration-700 -left-10 sm:left-10 md:left-24 xl:left-40 hover:-left-[20rem] md:hover:-left-[10rem] pt-8 lg:pt-28 lg:pr-[40px]">
          <div className="transition-all ease-in delay-150 duration-1000 bg-teal-900 h-[9rem] w-[33rem] lg:hover:w-[48rem] rounded-md place-self-end pl-8 flex flex-row space-x-6">
