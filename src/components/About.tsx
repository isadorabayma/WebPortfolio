...
export function About() {
  return(
    <div className="h-full flex flex-col">
      <div className="h-96 py-7 flex flex-row">
        <div className="w-28 bg-stone-300"></div>
        <img
          src={Perfil}
          alt="Foto de perfil da Isadora"
          className="px-3 w-60 object-cover object-righ grayscale-[45%]"
        />
        <div className="w-full bg-stone-300"></div>
      </div>
      <div className="flex items-end">
        <span className="pb-10 px-5 indent-12 text-lg w-full text-justify font-sans">
