...
export function Header({handleSection, sectionInfo, tagClicked}: HeaderProps) {
  return (
    <nav className="flex z-10 bg-[#ccc4c1]/80 justify-between sm:justify-end text-sm sm:text-base h-12 px-2 sm:px-10 space-x-4 sm:space-x-6 border-b-2 border-b-[#615b54] text-stone-900">
