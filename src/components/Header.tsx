...
export function Header({handleSection, sectionInfo, tagClicked}: HeaderProps) {
  return (
    <nav className="flex z-10 bg-stone-300/70 md:bg-auto justify-center sm:justify-end text-sm sm:text-base h-12 px-2 sm:px-10 space-x-4 sm:space-x-6 border-b-2 border-b-stone-800 text-stone-900">
