...
export function Cv(props: CvProps) {
  return (
    <div
      className={`transition-all ease-in delay-150 duration-1000 absolute top-0 z-${props.z} drop-shadow-xl hover:drop-shadow-2xl w-[35rem] h-[50rem] m-16  hover:ml-40 ${props.rotate} hover:rotate-0 hover:m-4 ring-1 ring-gray-900/5 ${props.color} hover:z-10`}
    >
      {/* <img
