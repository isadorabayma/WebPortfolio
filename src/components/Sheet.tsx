...
export function Sheet({name, z, rotate, right, handleClick}: SheetProps) {
  return (
    <div id="sheet" className={`absolute transition-all ease-in-out duration-1000 right-12 ${z} ${rotate} ${right} m-20 drop-shadow-xl bg-stone-200 ring-1 ring-gray-900/10 w-[35rem] h-[50rem]`}>
